...
TARGETS="
board.cmo command.cmo state.cmo piece.cmo move.cmo
main.cmo gui.cmo translate.cmo test.cmo 
testVar.cmo testMove.cmo testCheckmate.cmo testPiece.cmo testState.cmo 
testCommand.cmo"
